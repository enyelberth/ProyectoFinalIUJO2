...
namespace ProyectoFinalIUJO.Registros.RegistroDVD.MenudeDatosdeDVD
{
	partial class ElementosProducto
	{
		...
		private void InitializeComponent()
		{
			...
			this.labelcantidad.Click += new System.EventHandler(this.LabelcantidadClick);
			this.labelcantidad.MouseMove += new System.Windows.Forms.MouseEventHandler(this.LabelcantidadMouseMove);
			// 
			// pictureBoxproducto
			// 
			...
			this.pictureBoxproducto.MouseMove += new System.Windows.Forms.MouseEventHandler(this.PictureBoxproductoMouseMove);
			// 
			// labelcodigo
			// 
			...
			this.labelcodigo.Click += new System.EventHandler(this.LabelcodigoClick);
			this.labelcodigo.MouseMove += new System.Windows.Forms.MouseEventHandler(this.LabelcodigoMouseMove);
			// 
			// labelproducto
			// 
			...
			this.labelproducto.Click += new System.EventHandler(this.LabelproductoClick);
			this.labelproducto.MouseMove += new System.Windows.Forms.MouseEventHandler(this.LabelproductoMouseMove);
			// 
			// ElementosProducto
			// 
